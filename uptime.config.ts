...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/tang3855', label: 'GitHub' },
    { link: 'https://www.dst.de5.net/', label: '主页' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
     {
      ...
      name: 'sun界面（密码服务）',
      method: 'HEAD',
      target: 'https://www.zwz.qzz.io/',
      statusPageLink: 'https://www.zwz.qzz.io/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'VaultWarden',
      method: 'HEAD',
      target: 'https://bwfs.zwz.qzz.io/',
      statusPageLink: 'https://bwfs.zwz.qzz.io/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'home-assistant',
      method: 'GET',
      target: 'https://ha.zwz.qzz.io/',
    //target: 'https://hafs.zwz.qzz.io/auth/authorize?response_type=code&redirect_uri=https%3A%2F%2Fhafs.zwz.qzz.io%2F%3Fauth_callback%3D1&client_id=https%3A%2F%2Fhafs.zwz.qzz.io%2F&state=eyJoYXNzVXJsIjoiaHR0cHM6Ly9oYWZzLnp3ei5xenouaW8iLCJjbGllbnRJZCI6Imh0dHBzOi8vaGFmcy56d3oucXp6LmlvLyJ9',
      statusPageLink: 'https://ha.zwz.qzz.io/',
      hideLatencyChart: false,
     //expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'sun界面（nasless）',
      method: 'HEAD',
      target: 'https://sun.dst.de5.net/',
      statusPageLink: 'https://sun.dst.de5.net/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'PVE界面',
      method: 'GET',
      target: 'https://pve.dst.de5.net/#v1:0:18:4:::::::/',
      statusPageLink: 'https://pve.dst.de5.net/#v1:0:18:4:::::::/',
      hideLatencyChart: false,
    //expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '飞牛（233）',
      method: 'HEAD',
      target: 'https://fn.dst.de5.net/',
      statusPageLink: 'https://fn.dst.de5.net/',
      hideLatencyChart: false,
    //expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '飞牛（nasless）',
      method: 'HEAD',
      target: 'https://nas.dst.de5.net/',
      statusPageLink: 'https://nas.dst.de5.net/',
      hideLatencyChart: false,
    //expectedCodes: [200],
      timeout: 10000,
    }
